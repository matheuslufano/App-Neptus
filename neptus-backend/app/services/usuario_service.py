...
class UsuarioService:
    @staticmethod
    def registrar_usuario(db: Session, nome: str, email: str, senha: str, perfil_id: str):
        ...
        if perfil_id:
            ...
            # Note: This might need a refactor to accept db in default_perfil if it queries the DB
    ...
    @staticmethod
    def atualizar_usuario(db: Session, id: str, nome: str, email: str, perfil_id: str):
    ...
    @staticmethod
    def status_usuario(db: Session, id: str, status: bool):
        if status is None:
